...
func (h *Handler) Routes() chi.Router {
	...
	r.Get("/projects/{project_id}/specs", h.listTaskSpecs)
	r.Post("/projects/{project_id}/specs", h.createTaskSpec)
	r.Get("/projects/{project_id}/pr-reviews", h.listPRReviews)
	r.Post("/projects/{project_id}/pr-reviews", h.createPRReview)
	r.Get("/specs/{spec_id}", h.getTaskSpec)
	r.Put("/specs/{spec_id}", h.updateTaskSpec)
	r.Get("/pr-reviews/{review_id}", h.getPRReview)
	r.Get("/pr-reviews/{review_id}/findings", h.listPRReviewFindings)
	r.Get("/pr-reviews/{review_id}/files", h.listPRReviewFiles)
